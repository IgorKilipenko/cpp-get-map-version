...
namespace maps::tests /* Stream operators override */ {
    template <class T>
...
namespace maps::tests /* TestRunner */ {
    class TestRunner {
    public:
...
namespace maps::tests /* Asserts defs */ {
